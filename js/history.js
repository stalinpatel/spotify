...
function updateSongDetails(curr_song) {
  ...
  console.log("song details updates successfully");
}
...
async function main() {
  ...
  songs = await getSongs(currFolder_URI);
  ...
  // MAKE THE FIRST SONG SELECTED BY DEFAULT
  updatePlayingCard(curr_song);
